...
public class BleConnector {
                ...
                switch (msg.what) {
                    ...
                    case BleMsg.MSG_CHA_NOTIFY_START: {
                        ...
                        if (notifyCallback != null)
                            notifyCallback.onNotifyFailure(notifyCallback.getMac(),new TimeoutException());
                        break;
                    }
                    ...
                    case BleMsg.MSG_CHA_NOTIFY_RESULT: {
                        ...
                        String strMac = bundle.getString(BleMsg.KEY_NOTIFY_MAC_BUNDLE_STATUS);
                        int status = bundle.getInt(BleMsg.KEY_NOTIFY_BUNDLE_STATUS);
                        if (notifyCallback != null) {
                            if (status == BluetoothGatt.GATT_SUCCESS) {
                                notifyCallback.onNotifySuccess(strMac);
                            } else {
                                notifyCallback.onNotifyFailure(strMac,new GattException(status));
                            }
                        }
                        break;
                    }
                    ...
                    case BleMsg.MSG_CHA_NOTIFY_DATA_CHANGE: {
                        BleNotifyCallback notifyCallback = (BleNotifyCallback) msg.obj;
                        Bundle bundle = msg.getData();
                        String strMac = bundle.getString(BleMsg.KEY_NOTIFY_MAC_BUNDLE_VALUE);
                        byte[] value = bundle.getByteArray(BleMsg.KEY_NOTIFY_BUNDLE_VALUE);
                        if (notifyCallback != null) {
                            notifyCallback.onCharacteristicChanged(strMac,value);
                        }
                        break;
                    }
                    ...
                    case BleMsg.MSG_CHA_INDICATE_START: {
                        ...
                        if (indicateCallback != null)
                            indicateCallback.onIndicateFailure(indicateCallback.getMac(),new TimeoutException());
                        break;
                    }
                    ...
                    case BleMsg.MSG_CHA_INDICATE_RESULT: {
                        ...
                        BleIndicateCallback indicateCallback = (BleIndicateCallback) msg.obj;
                        Bundle bundle = msg.getData();
                        String strMac = bundle.getString(BleMsg.KEY_INDICATE_MAC_BUNDLE_VALUE);
                        int status = bundle.getInt(BleMsg.KEY_INDICATE_BUNDLE_STATUS);
                        if (indicateCallback != null) {
                            if (status == BluetoothGatt.GATT_SUCCESS) {
                                indicateCallback.onIndicateSuccess(strMac);
                            } else {
                                indicateCallback.onIndicateFailure(strMac,new GattException(status));
                            }
                        }
                        break;
                    }
                    ...
                    case BleMsg.MSG_CHA_INDICATE_DATA_CHANGE: {
                        ...
                        if (indicateCallback != null) {
                            indicateCallback.onCharacteristicChanged(strMac,value);
                        }
                        break;
                    }
     ...
     * notify
     */
    public void enableCharacteristicNotify(String strMac, BleNotifyCallback bleNotifyCallback, String uuid_notify,
                                           boolean userCharacteristicDescriptor) {
        if (mCharacteristic != null
                && (mCharacteristic.getProperties() | BluetoothGattCharacteristic.PROPERTY_NOTIFY) > 0) {

            handleCharacteristicNotifyCallback(strMac,bleNotifyCallback, uuid_notify);
            setCharacteristicNotification(mBluetoothGatt, mCharacteristic, userCharacteristicDescriptor, true, bleNotifyCallback);
        } else {
            if (bleNotifyCallback != null)
                bleNotifyCallback.onNotifyFailure(strMac,new OtherException("this characteristic not support notify!"));
        }
    }
    ...
    private boolean setCharacteristicNotification(BluetoothGatt gatt,
        ...
        if (gatt == null || characteristic == null) {
            notifyMsgInit();
            if (bleNotifyCallback != null)
                bleNotifyCallback.onNotifyFailure(gatt.getDevice().getAddress(),new OtherException("gatt or characteristic equal null"));
            return false;
        }
        ...
        if (!success1) {
            notifyMsgInit();
            if (bleNotifyCallback != null)
                bleNotifyCallback.onNotifyFailure(gatt.getDevice().getAddress(),new OtherException("gatt setCharacteristicNotification fail"));
            return false;
        }
        ...
        if (descriptor == null) {
            notifyMsgInit();
            if (bleNotifyCallback != null)
                bleNotifyCallback.onNotifyFailure(gatt.getDevice().getAddress(),new OtherException("descriptor equals null"));
            return false;
        } else {
            ...
            if (!success2) {
                notifyMsgInit();
                if (bleNotifyCallback != null)
                    bleNotifyCallback.onNotifyFailure(gatt.getDevice().getAddress(),new OtherException("gatt writeDescriptor fail"));
            }
            return success2;
        }
    }
     ...
     * indicate
     */
    public void enableCharacteristicIndicate(String strMac,BleIndicateCallback bleIndicateCallback, String uuid_indicate,
                                             boolean useCharacteristicDescriptor) {
        if (mCharacteristic != null
                && (mCharacteristic.getProperties() | BluetoothGattCharacteristic.PROPERTY_NOTIFY) > 0) {
            handleCharacteristicIndicateCallback(strMac,bleIndicateCallback, uuid_indicate);
            setCharacteristicIndication(mBluetoothGatt, mCharacteristic,
                    useCharacteristicDescriptor, true, bleIndicateCallback);
        } else {
            if (bleIndicateCallback != null)
                bleIndicateCallback.onIndicateFailure(strMac,new OtherException("this characteristic not support indicate!"));
        }
    }
    ...
    private boolean setCharacteristicIndication(BluetoothGatt gatt,
        ...
        if (gatt == null || characteristic == null) {
            indicateMsgInit();
            if (bleIndicateCallback != null)
                bleIndicateCallback.onIndicateFailure(gatt.getDevice().getAddress(),new OtherException("gatt or characteristic equal null"));
            return false;
        }
        ...
        if (!success1) {
            indicateMsgInit();
            if (bleIndicateCallback != null)
                bleIndicateCallback.onIndicateFailure(gatt.getDevice().getAddress(),new OtherException("gatt setCharacteristicNotification fail"));
            return false;
        }
        ...
        if (descriptor == null) {
            indicateMsgInit();
            if (bleIndicateCallback != null)
                bleIndicateCallback.onIndicateFailure(gatt.getDevice().getAddress(),new OtherException("descriptor equals null"));
            return false;
        } else {
            ...
            if (!success2) {
                indicateMsgInit();
                if (bleIndicateCallback != null)
                    bleIndicateCallback.onIndicateFailure(gatt.getDevice().getAddress(),new OtherException("gatt writeDescriptor fail"));
            }
            return success2;
        }
    }
     ...
     * notify
     */
    private void handleCharacteristicNotifyCallback(String strMac, BleNotifyCallback bleNotifyCallback,
                                                    String uuid_notify) {
        if (bleNotifyCallback != null) {
            notifyMsgInit();
            bleNotifyCallback.setMac(strMac);
     ...
     * indicate
     */
    private void handleCharacteristicIndicateCallback(String strMac,BleIndicateCallback bleIndicateCallback,
                                                      String uuid_indicate) {
        if (bleIndicateCallback != null) {
            indicateMsgInit();
            bleIndicateCallback.setMac(strMac);
