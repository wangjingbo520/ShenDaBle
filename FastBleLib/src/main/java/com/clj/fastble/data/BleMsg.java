...
public class BleMsg {
    ...
    public static final String KEY_NOTIFY_MAC_BUNDLE_STATUS = "notify_mac_status";
    public static final String KEY_NOTIFY_BUNDLE_VALUE = "notify_value";
    public static final String KEY_NOTIFY_MAC_BUNDLE_VALUE = "notify_mac_value";
    ...
    public static final String KEY_INDICATE_MAC_BUNDLE_VALUE = "indicate_mac_value";
    // Write
